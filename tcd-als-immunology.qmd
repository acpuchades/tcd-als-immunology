...
Similarly to the survival effects observed for CD8-related cluster 2, the effects of CD8-related IL-21 is independent of sex, site of onset and age at onset, and there's only a significant interaction with age at onset.
...
As we saw, the effect of increased IL-21 CD8 response is associated with worse survival, and this effect is more pronounced in patients with an earlier age at onset.
...
### Sensitivity analysis: Unimputed dataset
