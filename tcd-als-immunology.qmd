...
However, this correlation is not driven by the individual markers, but rather by the combination of them. This suggests that the PCs are capturing a more complex relationship between the markers and age.
...
This effect is also not fully explained by a higher age at onset, but there seems to be an interaction where older patients in cluster 2 have a slightly better survival compared to younger individuals within that cluster.
